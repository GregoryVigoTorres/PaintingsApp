...
from Paintings.models.public import Series


def _bp_factory(mod_name, url_prefix, config_args=None, app=None, **kwargs):
    """ blueprint factory """    

    import_name = 'Paintings.{}'.format(mod_name)

    options = {'template_folder':'Paintings/{}/templates'.format(mod_name), 
               'static_folder':'Paintings/{}/static'.format(mod_name), 
